...
export const { addRamayan, addLeftMessage, addRightMessage, updateRightMessage, addSearchShloka, addSearchQuestion, addQuestionMessage, toggleSearchDisabled, makeAiPrompt, resetAi, togglePlay, toggleTranslate, toggleVocabulary } = ramayanSlice.actions;
